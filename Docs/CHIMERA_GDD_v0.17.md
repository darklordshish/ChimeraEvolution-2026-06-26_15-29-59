...
- **Эффект СТРАХА** (активный статус): жертва теряет управление и бежит — в том числе игрок. **Иммунитет — холоднокровное сердце** («холодный расчёт» как органная фича; змея и сама не паникует — принцип трёх режимов психики: спокойствие/настороженность/атака, вид маппит по-своему). Вводится, когда появится носитель-пугатель.

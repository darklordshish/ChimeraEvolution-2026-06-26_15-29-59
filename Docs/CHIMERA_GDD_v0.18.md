...
- **Животные-химеры по лесу** — редкое, но встречающееся событие: химеризованы не только боссы (родство уже копится ЛОКАЛЬНО в каждом теле — задел есть, разд. 2).
- **Эволюция видов — ОТКРЫТЫЙ ВОПРОС:** позволить другим видам самим химеризоваться (змея, наевшаяся волков, отращивает волчье). Заманчиво, но рискованно по балансу и читаемости — решается отдельно.

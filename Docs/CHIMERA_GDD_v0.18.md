...
- Финал зоны — босс-суперхимера (собирается конструктором; вервольф как отдельный вид снят 11.09)
...
> **Фундамент супер-химеры-босса — ГОТОВ (2026-07-31).** Босс-суперхимера строится «на готовом»: **морфология** (модель из состава), **эволюция** (химера, собранная убийствами), **диспатч психики** по составу (разд. 5.10). Останется прикрутить модуль боссовости (фазы/вой, часть — с вервольфа) — босс не с нуля. Это же и путь к Химере 0.

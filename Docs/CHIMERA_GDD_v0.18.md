...
| **Родство** | Привыкание к виду. Получает **УБИЙЦА**: +1 за каждый УНИКАЛЬНЫЙ видо-флаг убитого тела (шасси + доноры с надетыми органами); наблюдателю не капает. **Хранится ЛОКАЛЬНО в теле КАЖДОГО существа** (`CreatureBody`, глобального счётчика нет): все звери мира — эксперименты с сывороткой, и змея, съевшая волков, копит родство-волк — задел **эволюции химер-NPC**. Фаза 1 (0–80) — скидка на аугументы вида; фаза 2 (80–100) — мощь (экспрессия ×1…×2). Кап 100 на вид; родство с СОБСТВЕННЫМ шасси = 100 с рождения. Человечность игроку качают человеко-химеры (боссы). |

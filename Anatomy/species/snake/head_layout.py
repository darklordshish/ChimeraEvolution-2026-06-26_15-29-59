...
# ЗАМЕР ОБОЛОЧКИ на клетке 0.084 (`ProbeM.SurfaceX`, окно ±4 см): поверхность узла `голова` вбок у глаза 0.06…0.075 на
# высоте темени; глаз сидит на верхнем углу головы и выступает из-под щитка вбок — центр на 0.09
SURFACE_AT_EYE = 0.090

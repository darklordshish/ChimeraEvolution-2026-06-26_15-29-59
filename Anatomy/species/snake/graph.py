...
HEAD_TIP_Z = 0.30             # кончик рыла (25.09; было 0.39 — голова 0.56 длиной читалась ящерицей: у гремучника длина ~1.4 ширины)
...
HEAD_W, HEAD_H = 0.34, 0.26        # высота 0.26 (25.09): ВЫШЕ ШЕИ 0.215 — при 0.19–0.20 шея была выше головы, голова читалась продолжением тела (угорь). Плоское темя даёт блок рыла; ширина по щекам 0.34 (25.09; было 0.30 — щёки всего в 1.4 раза шире шеи 0.215, у гремучника 1.5–1.8)
FRONT = {'сзади': 1.00, 'у_глаз': 0.59, 'у_рыла': 0.55}
SKULL_END_Z = 0.06            # конец черепа: внутри блока рыла (было 0.10, 0.17, 0.25, 0.12 — конец выходил зубцом из бока рыла); череп — затылок и щёки

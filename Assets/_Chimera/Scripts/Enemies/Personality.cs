...
/// спавне (устойчиво — не шум), делает особей в стае чуть разными = «колесо жизни экосистемы». Четыре оси:
/// ХРАБРОСТЬ (порог Страха — кто ломается первым), АГРЕССИЯ (как охотно лезет в атаку / частит), ЛЮБОПЫТСТВО
/// (как охотно идёт на зацепку — гремок/след), ОСТОРОЖНОСТЬ (змея: как долго выжидает в сокрытии после
/// бегства и как охотно отползает по стене от стаи — её ось, как у волков мораль). Игрок детерминирован
/// (личность не вешаем). Психика опрашивает.
/// </summary>

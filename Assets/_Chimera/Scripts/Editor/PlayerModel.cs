...
public static class PlayerModel
{
    ...
    public static void Rebuild()
    {
        ...
        // (`MorphBuilder` по якорям шасси, в рантайме, с пересборкой при химеризации). Статичные кубы были бы
        // ДУБЛЕМ (тот же случай, что у волка: «оброс кубами»). Меню теперь ЧИСТИТ старую модель — прогони
        // один раз и сохрани сцену. Сборка ниже сохранена как справка/откат (числа лица и пропорций).
        /*

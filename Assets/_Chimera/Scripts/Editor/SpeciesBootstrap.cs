...
public static class SpeciesBootstrap
{
    ...
    public static void CreateDefaults()
    {
        ...
        wolf.bones = new[]
        {
            ...
            //     ОСЬ ИДЁТ ОТ ГОЛОВЫ (спека 2026-08-27): корень — «коробка» (череп), дальше шея → грудной →
            // поясница → крестец → хвост. Голова единственное место, которое есть у всех пяти видов; хребта
            // нет у змеи, поэтому корень «хребет» универсальным быть не может по построению. Разворот
            // считает генератор (`wolf.py`, reverse_axis) и самопроверяет: скелет не сдвинулся ни на мм.
            //     У 26 КОСТЕЙ dir ИМЕЕТ Y = 180. Это не украшение: разложение поворота в углы Unity при
            // повороте оси на 180° уходит в ветку с ненулевым Y, и пока генератор печатал только X и Z,
            // компонент молча терялся — волк приезжал вывернутым. До разворота Y везде был нулём, поэтому
            // усечённая печать сходила годами.
            //     ИМЯ КОСТИ = АНАТОМИЯ + СЛОЙ: `.м` мышца, `.п` признак, `.р` рез; скелет без суффикса.
            //     ПОЗА СНЯТА С ФОТОГРАФИИ (`etalon/body.py`): шея поднимается вперёд-вверх, затылок стоит
            // ВЫШЕ холки. Прежние данные держали голову на уровне спины — ошибка эталона из таблиц.
            new Bone { name = "коробка", socket = "голова", origin = new Vector3(0.000f, 1.245f, 0.800f), length = 0.180f, dir = new Vector3(88.3f, 180.0f, 180.0f), r0 = 0.074f, r1 = 0.068f, section = 1.15f },
            new Bone { name = "шея", socket = "шея", parent = "коробка", attach = 0.00f, length = 0.437f, dir = new Vector3(31.2f, 180.0f, 180.0f), r0 = 0.134f, r1 = 0.116f, section = 1.05f },
            new Bone { name = "грудной", socket = "хребет", parent = "шея", length = 0.400f, dir = new Vector3(32.1f, 0.0f, 0.0f), r0 = 0.086f, r1 = 0.090f, section = 1.65f },
            new Bone { name = "поясница", socket = "хребет", parent = "грудной", length = 0.401f, dir = new Vector3(-6.6f, 0.0f, 0.0f), r0 = 0.082f, r1 = 0.086f, section = 1.75f },
            new Bone { name = "крестец", socket = "хребет", parent = "поясница", length = 0.181f, dir = new Vector3(-1.4f, 0.0f, 0.0f), r0 = 0.078f, r1 = 0.082f, section = 1.75f },
            new Bone { name = "хвост1", socket = "Хвост", parent = "крестец", length = 0.159f, dir = new Vector3(-58.8f, 0.0f, 0.0f), r0 = 0.090f, r1 = 0.088f, section = 0.95f },
            new Bone { name = "хвост2", socket = "Хвост", parent = "хвост1", length = 0.159f, dir = new Vector3(-0.0f, 0.0f, 0.0f), r0 = 0.088f, r1 = 0.086f, section = 0.95f },
            new Bone { name = "хвост3", socket = "Хвост", parent = "хвост2", length = 0.160f, dir = new Vector3(-0.2f, 0.0f, 0.0f), r0 = 0.086f, r1 = 0.078f, section = 0.95f },
            new Bone { name = "хвост4", socket = "Хвост", parent = "хвост3", length = 0.159f, dir = new Vector3(0.2f, 0.0f, 0.0f), r0 = 0.078f, r1 = 0.060f, section = 0.95f },
            new Bone { name = "таз", socket = "Ноги", parent = "крестец", attach = 0.45f, length = 0.280f, dir = new Vector3(-86.1f, 0.0f, -19.6f), r0 = 0.112f, r1 = 0.104f, section = 0.86f, blend = 0.035f, mirrorX = true },
            new Bone { name = "бедро", socket = "Ноги", parent = "таз", length = 0.319f, dir = new Vector3(-56.0f, -0.0f, 11.3f), r0 = 0.118f, r1 = 0.062f, section = 0.78f, blend = 0.035f, mirrorX = true },
            new Bone { name = "голень", socket = "Ноги", parent = "бедро", length = 0.350f, dir = new Vector3(87.1f, -180.0f, -163.9f), r0 = 0.060f, r1 = 0.032f, section = 0.85f, blend = 0.035f, mirrorX = true },
            new Bone { name = "плюсна", socket = "Ноги", parent = "голень", length = 0.221f, dir = new Vector3(-50.0f, -0.0f, 0.6f), r0 = 0.032f, r1 = 0.026f, section = 0.85f, blend = 0.035f, mirrorX = true },
            new Bone { name = "лапа_з", socket = "Ноги", parent = "плюсна", length = 0.054f, dir = new Vector3(-27.4f, 0.0f, 0.2f), r0 = 0.026f, r1 = 0.032f, section = 1.15f, blend = 0.035f, mirrorX = true },
            new Bone { name = "отросток1", socket = "хребет", parent = "поясница", attach = 0.90f, length = 0.141f, dir = new Vector3(-86.0f, 0.0f, -38.7f), r0 = 0.030f, r1 = 0.024f, section = 0.80f, mirrorX = true },
            new Bone { name = "отросток2", socket = "хребет", parent = "поясница", attach = 0.62f, length = 0.149f, dir = new Vector3(-86.0f, 0.0f, -36.3f), r0 = 0.030f, r1 = 0.024f, section = 0.80f, mirrorX = true },
            new Bone { name = "отросток3", socket = "хребет", parent = "поясница", attach = 0.34f, length = 0.149f, dir = new Vector3(-86.0f, 0.0f, -36.3f), r0 = 0.030f, r1 = 0.024f, section = 0.80f, mirrorX = true },
            new Bone { name = "отросток4", socket = "хребет", parent = "поясница", attach = 0.08f, length = 0.141f, dir = new Vector3(-86.0f, 0.0f, -38.7f), r0 = 0.030f, r1 = 0.024f, section = 0.80f, mirrorX = true },
            new Bone { name = "ребро1", socket = "Сердце", parent = "грудной", attach = 0.95f, length = 0.107f, dir = new Vector3(-87.4f, 180.0f, 144.6f), r0 = 0.062f, r1 = 0.058f, section = 0.80f, mirrorX = true },
            new Bone { name = "ребро1с", socket = "Сердце", parent = "ребро1", length = 0.141f, dir = new Vector3(-0.0f, -0.0f, 27.3f), r0 = 0.058f, r1 = 0.050f, section = 0.80f, mirrorX = true },
            new Bone { name = "ребро1н", socket = "Сердце", parent = "ребро1с", length = 0.074f, dir = new Vector3(-0.0f, -0.0f, 44.4f), r0 = 0.050f, r1 = 0.040f, section = 0.80f, mirrorX = true },
            new Bone { name = "ребро2", socket = "Сердце", parent = "грудной", attach = 0.76f, length = 0.104f, dir = new Vector3(-87.4f, 180.0f, 143.5f), r0 = 0.068f, r1 = 0.064f, section = 0.80f, mirrorX = true },
            new Bone { name = "ребро2с", socket = "Сердце", parent = "ребро2", length = 0.141f, dir = new Vector3(-0.0f, -0.0f, 28.4f), r0 = 0.064f, r1 = 0.055f, section = 0.80f, mirrorX = true },
            new Bone { name = "ребро2н", socket = "Сердце", parent = "ребро2с", length = 0.114f, dir = new Vector3(-0.0f, -0.0f, 30.8f), r0 = 0.055f, r1 = 0.044f, section = 0.80f, mirrorX = true },
            new Bone { name = "ребро3", socket = "Сердце", parent = "грудной", attach = 0.56f, length = 0.101f, dir = new Vector3(-87.4f, 180.0f, 142.2f), r0 = 0.070f, r1 = 0.066f, section = 0.80f, mirrorX = true },
            new Bone { name = "ребро3с", socket = "Сердце", parent = "ребро3", length = 0.141f, dir = new Vector3(-0.0f, -0.0f, 29.7f), r0 = 0.066f, r1 = 0.057f, section = 0.80f, mirrorX = true },
            new Bone { name = "ребро3н", socket = "Сердце", parent = "ребро3с", length = 0.137f, dir = new Vector3(-0.0f, -0.0f, 26.8f), r0 = 0.057f, r1 = 0.046f, section = 0.80f, mirrorX = true },
            new Bone { name = "ребро4", socket = "Сердце", parent = "грудной", attach = 0.36f, length = 0.098f, dir = new Vector3(-87.4f, 180.0f, 140.9f), r0 = 0.068f, r1 = 0.064f, section = 0.80f, mirrorX = true },
            new Bone { name = "ребро4с", socket = "Сердце", parent = "ребро4", length = 0.141f, dir = new Vector3(-0.0f, -0.0f, 31.0f), r0 = 0.064f, r1 = 0.055f, section = 0.80f, mirrorX = true },
            new Bone { name = "ребро4н", socket = "Сердце", parent = "ребро4с", length = 0.142f, dir = new Vector3(-0.0f, -0.0f, 26.2f), r0 = 0.055f, r1 = 0.044f, section = 0.80f, mirrorX = true },
            new Bone { name = "лопатка", socket = "Руки", parent = "ребро4", attach = 0.45f, length = 0.304f, dir = new Vector3(-42.3f, -0.0f, 18.8f), r0 = 0.088f, r1 = 0.070f, section = 0.65f, blend = 0.035f, mirrorX = true },
            new Bone { name = "плечо", socket = "Руки", parent = "лопатка", length = 0.316f, dir = new Vector3(88.6f, 180.0f, -154.6f), r0 = 0.062f, r1 = 0.046f, section = 0.80f, blend = 0.035f, mirrorX = true },
            new Bone { name = "предплечье", socket = "Руки", parent = "плечо", length = 0.317f, dir = new Vector3(-67.5f, -0.0f, 10.8f), r0 = 0.055f, r1 = 0.030f, section = 0.85f, blend = 0.035f, mirrorX = true },
            new Bone { name = "пясть", socket = "Руки", parent = "предплечье", length = 0.201f, dir = new Vector3(-2.0f, -0.0f, 0.1f), r0 = 0.030f, r1 = 0.026f, section = 0.85f, blend = 0.035f, mirrorX = true },
            new Bone { name = "лапа", socket = "Руки", parent = "пясть", length = 0.061f, dir = new Vector3(-17.1f, -0.0f, 1.3f), r0 = 0.026f, r1 = 0.032f, section = 1.15f, blend = 0.035f, mirrorX = true },
            new Bone { name = "ребро5", socket = "Сердце", parent = "грудной", attach = 0.16f, length = 0.096f, dir = new Vector3(-87.4f, 180.0f, 139.6f), r0 = 0.064f, r1 = 0.060f, section = 0.80f, mirrorX = true },
            new Bone { name = "ребро5с", socket = "Сердце", parent = "ребро5", length = 0.141f, dir = new Vector3(-0.0f, -0.0f, 32.3f), r0 = 0.060f, r1 = 0.052f, section = 0.80f, mirrorX = true },
            new Bone { name = "ребро5н", socket = "Сердце", parent = "ребро5с", length = 0.118f, dir = new Vector3(-0.0f, 0.0f, 29.9f), r0 = 0.052f, r1 = 0.042f, section = 0.80f, mirrorX = true },
            new Bone { name = "грудина", socket = "Сердце", parent = "грудной", attach = 0.05f, length = 0.283f, dir = new Vector3(-62.2f, 180.0f, 180.0f), r0 = 0.085f, r1 = 0.062f, section = 0.85f },
            new Bone { name = "ростр", socket = "голова", parent = "коробка", length = 0.183f, dir = new Vector3(26.1f, 0.0f, 0.0f), r0 = 0.062f, r1 = 0.040f, section = 1.15f, depth = 0.62f },
            new Bone { name = "гребень", socket = "голова", parent = "коробка", attach = 0.05f, length = 0.057f, dir = new Vector3(-89.2f, -0.0f, 0.0f), r0 = 0.026f, r1 = 0.020f, section = 0.50f },
            new Bone { name = "скула", socket = "голова", parent = "коробка", length = 0.122f, dir = new Vector3(62.7f, 180.0f, 135.3f), r0 = 0.030f, r1 = 0.025f, section = 1.00f, mirrorX = true },
            new Bone { name = "ветвь", socket = "Пасть", parent = "коробка", attach = 0.25f, length = 0.126f, dir = new Vector3(86.8f, 0.0f, -21.5f), r0 = 0.034f, r1 = 0.028f, section = 0.85f, mirrorX = true },
            new Bone { name = "челюсть", socket = "Пасть", parent = "ветвь", length = 0.267f, dir = new Vector3(-86.7f, -0.0f, 7.8f), r0 = 0.032f, r1 = 0.024f, section = 0.85f, mirrorX = true },

            // ══ СЛОЙ 2: МЫШЦЫ ══ У мышцы ДВА крепления (`endBone`): длину и угол ей не задают, они следуют
            // из положения костей. Подвинул сустав — подтянулась сама.
            new Bone { name = "икроножная.м", socket = "Ноги", parent = "бедро", attach = 0.90f, length = 0.391f, dir = new Vector3(81.5f, -0.0f, 16.0f), r0 = 0.052f, r1 = 0.032f, section = 0.85f, blend = 0.035f, endBone = "плюсна", endAttach = 0.25f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "четырёхглавая.м", socket = "Ноги", parent = "таз", attach = 0.75f, length = 0.367f, dir = new Vector3(-41.3f, -0.0f, 11.3f), r0 = 0.086f, r1 = 0.058f, section = 0.80f, blend = 0.035f, endBone = "голень", endAttach = 0.10f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "ягодичная.м", socket = "Ноги", parent = "крестец", attach = 0.40f, length = 0.302f, dir = new Vector3(-89.5f, -18.1f, 0.0f), r0 = 0.100f, r1 = 0.082f, section = 0.80f, blend = 0.035f, endBone = "бедро", endAttach = 0.12f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "двуглавая.м", socket = "Ноги", parent = "крестец", attach = 0.65f, length = 0.593f, dir = new Vector3(-71.9f, 180.0f, 170.9f), r0 = 0.098f, r1 = 0.062f, section = 0.78f, blend = 0.035f, endBone = "голень", endAttach = 0.35f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "полусухожильная.м", socket = "Ноги", parent = "крестец", attach = 0.85f, length = 0.630f, dir = new Vector3(-72.9f, 180.0f, 171.4f), r0 = 0.082f, r1 = 0.054f, section = 0.72f, blend = 0.035f, endBone = "голень", endAttach = 0.50f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "длиннейшая.м", socket = "хребет", parent = "отросток1", length = 0.329f, dir = new Vector3(-86.9f, -180.0f, 177.5f), r0 = 0.058f, r1 = 0.058f, section = 1.00f, endBone = "отросток4", endAttach = 1.00f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "широчайшая.м", socket = "хребет", parent = "поясница", attach = 0.15f, length = 0.458f, dir = new Vector3(-25.5f, 180.0f, 172.5f), r0 = 0.078f, r1 = 0.062f, section = 0.70f, endBone = "лопатка", endAttach = 0.55f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "брюшная.м", socket = "хребет", parent = "ребро1н", length = 0.497f, dir = new Vector3(85.1f, -180.0f, 177.2f), r0 = 0.084f, r1 = 0.078f, section = 0.85f, endBone = "таз", endAttach = 0.88f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "косая_живота.м", socket = "хребет", parent = "ребро2с", attach = 0.85f, length = 0.573f, dir = new Vector3(88.4f, 180.0f, -178.0f), r0 = 0.082f, r1 = 0.072f, section = 0.80f, endBone = "таз", endAttach = 0.60f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "зубчатая.м", socket = "Сердце", parent = "ребро3с", attach = 0.55f, length = 0.146f, dir = new Vector3(-62.9f, -180.0f, -171.5f), r0 = 0.070f, r1 = 0.056f, section = 0.70f, endBone = "лопатка", endAttach = 0.25f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "межрёберная.м", socket = "Сердце", parent = "ребро4с", attach = 0.60f, length = 0.236f, dir = new Vector3(89.9f, 0.0f, 0.0f), r0 = 0.070f, r1 = 0.066f, section = 0.85f, endBone = "ребро1с", endAttach = 0.60f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "сгибатели.м", socket = "Руки", parent = "предплечье", attach = 0.10f, length = 0.325f, dir = new Vector3(-0.2f, -0.0f, 0.0f), r0 = 0.044f, r1 = 0.028f, section = 0.85f, blend = 0.035f, endBone = "пясть", endAttach = 0.20f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "трицепс.м", socket = "Руки", parent = "лопатка", attach = 0.30f, length = 0.404f, dir = new Vector3(51.5f, -0.0f, 21.2f), r0 = 0.078f, r1 = 0.044f, section = 0.72f, blend = 0.035f, endBone = "предплечье", endAttach = 0.10f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "дельтовидная.м", socket = "Руки", parent = "лопатка", attach = 0.75f, length = 0.188f, dir = new Vector3(65.3f, -0.0f, 23.3f), r0 = 0.052f, r1 = 0.044f, section = 0.80f, blend = 0.035f, endBone = "плечо", endAttach = 0.55f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "бицепс.м", socket = "Руки", parent = "лопатка", attach = 0.90f, length = 0.370f, dir = new Vector3(70.7f, 0.0f, 26.8f), r0 = 0.048f, r1 = 0.038f, section = 0.80f, blend = 0.035f, endBone = "предплечье", endAttach = 0.30f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "длиннейшая_гр.м", socket = "хребет", parent = "ребро5", attach = 0.12f, length = 0.316f, dir = new Vector3(88.2f, 180.0f, 178.5f), r0 = 0.076f, r1 = 0.070f, section = 1.00f, endBone = "ребро1", endAttach = 0.12f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "грудная.м", socket = "Сердце", parent = "грудина", attach = 0.95f, length = 0.204f, dir = new Vector3(81.8f, 0.0f, -24.9f), r0 = 0.062f, r1 = 0.056f, section = 0.85f, endBone = "плечо", endAttach = 0.45f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "грудиночелюстная.м", socket = "шея", parent = "грудина", attach = 0.90f, length = 0.489f, dir = new Vector3(-69.3f, 180.0f, 175.7f), r0 = 0.062f, r1 = 0.048f, section = 0.80f, endBone = "ветвь", endAttach = 0.80f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "пластыревидная.м", socket = "шея", parent = "грудной", attach = 0.05f, length = 0.486f, dir = new Vector3(28.6f, 180.0f, 180.0f), r0 = 0.078f, r1 = 0.062f, section = 0.90f, endBone = "коробка", endAttach = 0.20f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "горловая.м", socket = "шея", parent = "шея", attach = 0.85f, length = 0.387f, dir = new Vector3(-12.8f, 180.0f, 175.9f), r0 = 0.070f, r1 = 0.052f, section = 0.85f, endBone = "ветвь", endAttach = 0.60f, layer = BodyLayer.Muscle },
            new Bone { name = "плечеголовная.м", socket = "Руки", parent = "шея", attach = 0.65f, length = 0.541f, dir = new Vector3(-32.0f, 0.0f, -9.1f), r0 = 0.050f, r1 = 0.058f, section = 0.70f, blend = 0.035f, endBone = "плечо", endAttach = 0.70f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "трапециевидная.м", socket = "хребет", parent = "шея", attach = 0.45f, length = 0.367f, dir = new Vector3(-6.5f, 0.0f, -7.1f), r0 = 0.070f, r1 = 0.058f, section = 0.85f, endBone = "лопатка", endAttach = 0.30f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "ромбовидная.м", socket = "хребет", parent = "шея", attach = 0.70f, length = 0.267f, dir = new Vector3(3.8f, 0.0f, -7.2f), r0 = 0.062f, r1 = 0.052f, section = 0.80f, endBone = "лопатка", endAttach = 0.10f, layer = BodyLayer.Muscle, mirrorX = true },
            new Bone { name = "жевательная.м", socket = "голова", parent = "скула", attach = 0.70f, length = 0.078f, dir = new Vector3(0.1f, 0.0f, 60.4f), r0 = 0.040f, r1 = 0.032f, section = 0.95f, endBone = "челюсть", endAttach = 0.25f, layer = BodyLayer.Muscle, mirrorX = true },

            // ══ СЛОЙ 3: ПРИЗНАКИ ══ Мелкая форма поверх готового тела: уши, мочка, надбровье, объёмы черепа.
            new Bone { name = "мочка.п", socket = "Чутьё", parent = "ростр", length = 0.025f, dir = new Vector3(27.2f, 0.0f, 0.0f), r0 = 0.030f, r1 = 0.024f, section = 1.10f, layer = BodyLayer.Feature },
            new Bone { name = "ухо.п", socket = "Чутьё", parent = "коробка", attach = 0.10f, length = 0.190f, dir = new Vector3(-61.2f, 0.0f, -29.0f), r0 = 0.046f, r1 = 0.030f, section = 1.00f, depth = 0.40f, layer = BodyLayer.Feature, mirrorX = true },
            new Bone { name = "надбровье.п", socket = "голова", parent = "коробка", attach = 0.80f, length = 0.060f, dir = new Vector3(-45.7f, 0.0f, -64.2f), r0 = 0.032f, r1 = 0.028f, section = 1.00f, depth = 0.75f, layer = BodyLayer.Feature, mirrorX = true },
            new Bone { name = "височная.п", socket = "голова", origin = new Vector3(0.038f, 1.257f, 0.826f), length = 0.080f, dir = new Vector3(77.1f, 180.0f, 177.1f), r0 = 0.030f, r1 = 0.034f, section = 1.00f, layer = BodyLayer.Feature, mirrorX = true },
            new Bone { name = "дуга.п", socket = "голова", origin = new Vector3(0.052f, 1.183f, 0.876f), length = 0.065f, dir = new Vector3(73.9f, 180.0f, 150.4f), r0 = 0.017f, r1 = 0.015f, section = 1.00f, depth = 0.50f, layer = BodyLayer.Feature, mirrorX = true },
            new Bone { name = "лоб_площадка.п", socket = "голова", origin = new Vector3(0.000f, 1.244f, 0.930f), length = 0.053f, dir = new Vector3(71.3f, 180.0f, 119.8f), r0 = 0.026f, r1 = 0.022f, section = 1.00f, depth = 0.55f, layer = BodyLayer.Feature, mirrorX = true },
            new Bone { name = "спинка_носа.п", socket = "голова", origin = new Vector3(0.000f, 1.215f, 0.983f), length = 0.159f, dir = new Vector3(70.6f, 180.0f, 180.0f), r0 = 0.026f, r1 = 0.019f, section = 1.40f, depth = 0.70f, layer = BodyLayer.Feature },
            new Bone { name = "вибриссы.п", socket = "Чутьё", origin = new Vector3(0.032f, 1.155f, 1.046f), length = 0.071f, dir = new Vector3(71.9f, 180.0f, -175.1f), r0 = 0.030f, r1 = 0.024f, section = 1.00f, layer = BodyLayer.Feature, mirrorX = true },
            new Bone { name = "губа_верх.п", socket = "Пасть", origin = new Vector3(0.030f, 1.140f, 1.025f), length = 0.087f, dir = new Vector3(76.0f, 180.0f, -174.7f), r0 = 0.016f, r1 = 0.013f, section = 1.10f, depth = 0.70f, layer = BodyLayer.Feature, mirrorX = true },
            new Bone { name = "подбородок_м.п", socket = "Пасть", origin = new Vector3(0.016f, 1.118f, 1.080f), length = 0.041f, dir = new Vector3(86.0f, 180.0f, -157.3f), r0 = 0.018f, r1 = 0.015f, section = 1.00f, layer = BodyLayer.Feature },
            new Bone { name = "затылок_бугор.п", socket = "голова", origin = new Vector3(0.000f, 1.263f, 0.791f), length = 0.047f, dir = new Vector3(-46.4f, 180.0f, 180.0f), r0 = 0.045f, r1 = 0.040f, section = 1.00f, layer = BodyLayer.Feature },

            // ══ СЛОЙ 4: ВЫЧИТАНИЕ ══ Рот и ноздри: щель можно только вырезать, наложением её не получить.
            new Bone { name = "ноздря.р", socket = "Чутьё", parent = "ростр", attach = 0.96f, length = 0.021f, dir = new Vector3(17.8f, 0.0f, 0.0f), r0 = 0.014f, r1 = 0.011f, section = 1.00f, endBone = "мочка.п", endAttach = 0.55f, layer = BodyLayer.Cut, mirrorX = true },
            new Bone { name = "рот.р", socket = "Пасть", parent = "челюсть", attach = 0.22f, length = 0.232f, dir = new Vector3(-14.2f, -0.0f, -1.2f), r0 = 0.015f, r1 = 0.012f, section = 1.00f, depth = 0.40f, endBone = "ростр", endAttach = 0.94f, layer = BodyLayer.Cut, mirrorX = true },
        };

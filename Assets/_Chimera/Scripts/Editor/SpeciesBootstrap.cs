...
public static class SpeciesBootstrap
{
    ...
    public static void CreateDefaults()
    {
        ...
        snake.sockets = new[]
        {
            ...
            new BodySocket { name = "хребет", localPos = new Vector3(0.000f, snakeBody * 0.5f, -1.640f), solid = true, linkDiameter = snakeBody, linkLength = 0.360f, linkTaper = 0.970f, chain = 5 }, // туловище: самое массивное, чуть сходит к хвосту

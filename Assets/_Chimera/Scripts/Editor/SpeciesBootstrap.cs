...
public static class SpeciesBootstrap
{
    ...
    public static void CreateDefaults()
    {
        ...
        // ЦЕЛЬ — 0.084 ГРАНЯМИ (выбор геймдизайнера 17.09 по тройке затенения, «третий»): ~1 160 треугольников поля.
        // НЕ ВКЛЮЧЕНО, потому что нынешний граф на 0.084 истончает предплечье до стебля 2.5×1.5 см (на 0.056 — 5–9 см):
        // клетка переключается ВМЕСТЕ с графом, который её держит, иначе в игру уходит заведомо сломанная лапа
        wolf.skinCell = 0.056f;

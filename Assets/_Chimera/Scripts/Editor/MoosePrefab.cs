...
public static class MoosePrefab
{
    ...
    public static GameObject BuildMoose()
    {
        ...
        */
        ...
        // числа тарана — в записи органа «Лосиные ноги» (ChargeData); довод о длине разбега переехал туда же
        PrefabConfig.Set(charge, ("gizmoHeight", 1.2f));
        var antler = go.AddComponent<AntlerAbility>(); // удар рогами по липнущим вплотную (урон+отлёт+кровь)
        PrefabConfig.Set(antler, ("gizmoHeight", 2.2f)); // числа рогов — в записи органа «Рога» (AntlerData)

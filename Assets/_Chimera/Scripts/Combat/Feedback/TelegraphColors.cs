...
/// Один источник правды: цвет означает одно и то же у всех видов и химер.
...
public static class TelegraphColors
{
    ...
    public static readonly Color Curl   = new(0.45f, 0.50f, 0.56f); // клубок (оборона ежа) — тёмно-свинцовый: свернулся в шар

...
public class Telegraph : MonoBehaviour
{
    ...
    // Конвенция имён головных частей: ей следуют и кубы-плейсхолдеры (`EarL`), и модели из Blender
    // (`Ear_L`) — отсюда сравнение по ПРЕФИКСУ, иначе у волка с настоящей моделью красились бы только
    ...
    static bool IsHeadName(string n) =>
        ...
        || n == "голова" || n == "Пасть" || n == "уши" || n == "глаза"; // МОРФ-части именуются по СОКЕТУ (имя = Organ.slot) — эмоции красят их же

...
public partial class CreatureBody
{
    ...
    /// фикс. экспрессия вида (волк 0.45, босс 2). Общая ручка: на неё вешаются и масштабы (радиус
    ...
    // Пороги прогрессии: ≥75 по всем → автоспавн босса (BossChimeraSpawner, по умолчанию выключен), ≥100 → химерный
    // слот (ChimeraSlotReward). До 11.09 порог 75 держал спавн вервольфа — вид удалён, босс собирается конструктором.

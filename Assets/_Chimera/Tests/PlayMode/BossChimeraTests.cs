...
namespace Chimera.Tests.PlayMode
{
    ...
    /// ШТУЧНЫЙ — разброс особи, который тянет за собой видовая психика, снят (решение Ф6).</summary>
    public class BossChimeraTests
    {
        ...
        public IEnumerator Bossness_HpMult_SurvivesRecompute()
        {
            ...
            // сторож не пустой: волчья доминанта приносит психику с разбросом особи — модуль обязан его снять
            Assert.IsTrue(boss.TryGetComponent<SpawnVariance>(out var v), "видовая психика не принесла разброс — сторож штучности пуст");

...
# НАПРАВЛЕНИЕ РЁБЕР — ОТ ГОЛОВЫ НАЗАД (спека 27.08, И1: «корень графа — голова, у всех видов без
# исключений; обход позвоночника идёт от головы назад»). Здесь оно сначала шло от крестца — я写
# граф, не сверившись со спекой, и получил третью структуру там, где спека сводила три к одной
EDGES = [
    ('затылок',    'шея_в',       'шея'),
    ('шея_в',      'грудь_в',     'шея'),
    ('грудь_в',    'поясница_в',  'хребет'),
    ('поясница_в', 'крестец',     'хребет'),
